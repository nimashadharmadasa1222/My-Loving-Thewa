...
if st.session_state.clicked_yes:
    ...
    with display_col2:
        ...
        <div class='message-box'>
            ...
            මම දන්නවා ඔයා හරි Answer එක තමයි දෙන්නේ කියලා ❤️ <br>
            ඉතින් මගේ රත්තරන් මම මේක ලියන්නේ ගොඩක් පාළුවෙන්.
            මගෙ හිතට ගොඩාක් දේවල් දැනෙනවා. දේවල් මේ වෙලාවේ ඔයාට කියන්න
            පුළුවන් උනා නම්... ඒත් ඔයා වැඩ නේ. මට ඉතින් කරදර කරන්න බෑනෙ.
            මගෙ හිතට හරි බයයි. මට ඔයාව ඕනි. ලගට දුවගෙන ඇවිත් බදාගෙන තුරුලු කරන් අඩන්න හිතෙනවා.<br>
            ...
            ඔයාව මගෙ﻿ ජීවිතේට ගොඩාක් වටිනවා.<br> මාව දාලා යන්නෙ නෑ නේද<br>
            ඔයා වෙනුවෙන්මයි මම මේක හැදුවේ  <br>
            I love you. 🌙❤️✨ <br>
                                 01/07/2026
        </div>
        """, unsafe_allow_html=True)
